...
const timelineSteps = [
  {
    icon: ClipboardCheck,
    title: "Manifest Quiz & Attorney Consult",
    duration: "(1-3 days)",
    description: [
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="text-lg text-muted-foreground mb-8 max-w-3xl mx-auto">
            We know speed matters, especially when you have a job offer, project deadline, or 
            looming immigration constraint. That's why we commit to firm turnaround times and a 
            streamlined, tech-enabled application process from day one.
          </p>
                  ...
                  <div className={`${isEven ? 'lg:order-2' : 'lg:order-1'}`}>
                    <div className="relative">
                      ...
                      {index < timelineSteps.length - 1 && (
                        <div className="hidden lg:block absolute left-0 top-full h-12 w-px bg-gradient-to-b from-primary/40 to-primary/0" 
